import {
  ...
  TaskRepositoryApprovedPayload as ContractsTaskRepositoryApprovedPayloadSchema,
...
export const TaskRepositoryApprovedPayload = ContractsTaskRepositoryApprovedPayloadSchema;
