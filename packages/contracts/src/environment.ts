...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server understands task grouping and task-aware thread commands.
      Absent on older servers, so clients keep the standalone-thread UI. */
  taskThreads: Schema.optionalKey(Schema.Boolean),
});
